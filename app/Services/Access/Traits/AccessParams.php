...
trait AccessParams {
	...
	public function getAssets($request, $params) {
                $assets['organizations'] = $this->getOrganizations($request, $params);
	 ...
	 * @return array|bool
	 */
	private function getOrganizations($request, $params) {
		return !is_null($params) ? $this->getParamFromController($params, "organization") : $this->getParamFromRoute($request, "organization");
	}
